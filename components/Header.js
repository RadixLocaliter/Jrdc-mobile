...
const BellButton = ({ isWhite, style, navigation }) => (
  ...
  >
    <Icon
      ...
      size={20}
      name="bulb"
      color={nowTheme.COLORS[isWhite ? 'WHITE' : 'WHITE']}
    />
...
class Header extends React.Component {
  ...
  render() {
    ...
    const navbarStyles = [styles.navbar, nowTheme.COLORS.APP_BACKGROUND && { backgroundColor: nowTheme.COLORS.APP_BACKGROUND }];
        ...
        <NavBar
          ...
          left={
            <Icon
              ...
              color={iconColor || (white ? nowTheme.COLORS.WHITE : nowTheme.COLORS.WHITE)}
            />
          }
          leftStyle={{ paddingVertical: 12 }}
          titleStyle={[
            styles.title,
            { color: nowTheme.COLORS[white ? 'WHITE' : 'WHITE'] },
...
const styles = StyleSheet.create({
  ...
  navbar: {
    ...
    paddingTop: iPhoneX ? theme.SIZES.BASE * 3 : theme.SIZES.BASE* 1.5,
