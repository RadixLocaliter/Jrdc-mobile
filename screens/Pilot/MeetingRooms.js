...
import { HeaderHeight, axiosInstance,PilotCategoryId } from '../../constants/utils';
...
export default class MeetingRooms extends React.Component {
    ...
    getMeetingRooms = () => {
        axiosInstance.get('wp-json/wc/v3/products?order=asc&category='+PilotCategoryId)
            .then((response) => {
                    ...
                    return (                      
                        <Block key={index} card style={styles.item}>
                            ...
                            <Button
                                ...
                                onPress={() => navigation.navigate('Pilot', { screen: 'Pilot', params: { id: res.id }})}
                            >
                                <Text
