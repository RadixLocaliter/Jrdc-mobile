...
import { HeaderHeight, axiosInstance,MeetingRoomCategoryId } from '../../constants/utils';
...
export default class MeetingRooms extends React.Component {
    ...
    getMeetingRooms = () => {
        axiosInstance.get('wp-json/wc/v3/products?order=asc&category='+MeetingRoomCategoryId)
            .then((response) => {
                    ...
                    return (                      
                        <Block key={index} card style={styles.item}>
                            ...
                            <Button
                                ...
                                onPress={() => navigation.navigate('MeetingRoom', { screen: 'MeetingRoom', params: { id: res.id }})}
                            >
                                <Text
