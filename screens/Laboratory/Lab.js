                        ...
                        <DataTable.Header>
                            ...
                            <DataTable.Row >
                                <DataTable.Cell>
                                    <Text
                                        size={14}
                                        style={this.state.time=="9:30 am" ? styles.timeSelect:""}
                                        color={nowTheme.COLORS.HEADER}
                                        onPress={()=>this.timePress('9:30 am')}
                                    >
                                        9:30 am
                                    </Text>
                                </DataTable.Cell>
                                <DataTable.Cell>
                                    <Text
                                        size={14}
                                        style={this.state.time=="12:30 pm" ? styles.timeSelect:""}
                                        color={nowTheme.COLORS.HEADER}
                                        onPress={()=>this.timePress('12:30 pm')}
                                    >
                                        12:30 pm
                                    </Text>
                                </DataTable.Cell>
                            ...
                            <DataTable.Row >
                                <DataTable.Cell>
                                    <Text
                                        size={14}
                                        style={this.state.time=="10:30 am" ? styles.timeSelect:""}
                                  
                                        color={nowTheme.COLORS.HEADER}
                                        onPress={()=>this.timePress('10:30 am')}
                                    >
                                        10:30 am
                                    </Text>
                                </DataTable.Cell>
                                ...
                                <DataTable.Cell>
                                    <Text
                                        size={14}
                                        style={this.state.time=="1:30 pm" ? styles.timeSelect:""}                                        
                                        color={nowTheme.COLORS.HEADER}
                                        onPress={()=>this.timePress('1:30 pm')}
                                    >
                                        1:30 pm
                                    </Text>
                                </DataTable.Cell>
                            ...
                            <DataTable.Row >
                                <DataTable.Cell>
                                    <Text
                                        size={14}
                                        style={this.state.time=="11:30 am" ? styles.timeSelect:""}                                  
                                        color={nowTheme.COLORS.HEADER}
                                        onPress={()=>this.timePress('11:30 am')}
                                    >
                                        11:30 am
                                    </Text>
                                </DataTable.Cell>
                                ...
                                <DataTable.Cell>
                                    <Text
                                        size={14}
                                        style={this.state.time=="2:30 pm" ? styles.timeSelect:""}                                   
                                        color={nowTheme.COLORS.HEADER}
                                        onPress={()=>this.timePress('2:30 pm')}
                                    >
                                        2:30 pm
                                    </Text>
                                </DataTable.Cell>
                            ...
                            <DataTable.Row >
                                ...
                                <DataTable.Cell>
                                    <Text
                                        size={14}
                                        style={this.state.time=="3:30 pm" ? styles.timeSelect:""}                                   
                                        color={nowTheme.COLORS.HEADER}
                                        onPress={()=>this.timePress('3:30 pm')}
                                    >
                                        3:30 pm
                                    </Text>
                                </DataTable.Cell>
                            ...
                            <DataTable.Row >
                                ...
                                <DataTable.Cell>
                                    <Text
                                        size={14}
                                        style={this.state.time=="4:30 pm" ? styles.timeSelect:""}  
                                        color={nowTheme.COLORS.HEADER}
                                        onPress={()=>this.timePress('4:30 pm')}
                                    >
                                        4:30 pm
                                    </Text>
                                </DataTable.Cell>
                ...
                >
                    ...
                    <View style={styles.duration}>
                        ...
                        >
                            ...
                            <Picker.Item label="1 Hour and 30 Minutes " value="3" />
                            <Picker.Item label="2 Hour" value="4" />
                            <Picker.Item label="2 Hour and 30 Minutes " value="5" />
                            <Picker.Item label="3 Hour" value="6" />
                            <Picker.Item label="3 Hour and 30 Minutes " value="7" />
                            <Picker.Item label="4 Hour" value="8" />
                            <Picker.Item label="4 Hour and 30 Minutes " value="9" />
                            <Picker.Item label="5 Hour" value="10" />
                            <Picker.Item label="5 Hour and 30 Minutes " value="11" />
                            <Picker.Item label="6 Hour" value="12" />
                            <Picker.Item label="6 Hour and 30 Minutes " value="13" />
                            <Picker.Item label="7 Hour" value="14" />
                            <Picker.Item label="7 Hour and 30 Minutes " value="16" />
                            <Picker.Item label="8 Hour" value="17" />
                            <Picker.Item label="8 Hour and 30 Minutes " value="18" />
                        </Picker>
                    </View>           
                <Block row>
                    <Text
                ...
                <Block row>
                    ...
                    <Button
                        ...
                        color={nowTheme.COLORS.APP_BULE}
                                onPress={() => navigation.navigate('LabRequest',                                    {
                                        screen: 'LabRequest',
                                        params: {
