...
export default class ConfirmRequestTest extends React.Component {
    ...
    request = () => {
        var data = {
            ...
            line_items: [
                {
                    name: "Request Water Test",
                    product_id: this.props.route.params.productId,
                    variation_id: 0,
                    quantity: 1,
                    tax_class: "",
                    subtotal: this.props.route.params.price.toString(),
                    subtotal_tax: "0.00",
                    total: this.props.route.params.price.toString(),
                    total_ta: "0.00",
                    taxes: [],
                    meta_data: [
                        {
                            id: 2916,
                            key: "Test Type",
                            value: this.props.route.params.noOfHours== 1 ? "Test Type A":"Test Type B",
                            display_key: "Test Type",
                            display_value: this.props.route.params.noOfHours== 1 ? "Test Type A":"Test Type B"
                        }
                    ],
                    sku: "540-1",
