...
import { HeaderHeight, axiosInstance,RoomCategoryId} from '../../constants/utils';
...
export default class Type extends React.Component {
    ...
    getAccommodations = () => {
        axiosInstance.get('wp-json/wc/v3/products?order=asc&category='+RoomCategoryId)
            .then((response) => {
                    ...
                    return (
                        <Block key={index} card style={styles.item}>
                            ...
                            <Button
                                ...
                                onPress={() => navigation.navigate('Room', { screen: 'Room', params: { id: res.id } })}
                            >
                                <Text
