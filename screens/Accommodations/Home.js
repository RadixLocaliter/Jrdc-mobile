                        ...
                        return (                         
                           ids.find(el=>el === res.line_items[0].product_id) ?
                            <Block key={index} row middle card >
                                ...
                                <Block style={{ marginLeft: theme.SIZES.BASE/2,marginRight: theme.SIZES.BASE/2 }} >
                                    <Chip>{res.status}</Chip>
                                </Block>
                                <Block right style={{ marginRight: theme.SIZES.BASE/2 }}>
                                    {/* <Icon
                                    size={28}
        ...
        return (
            <Block flex>
                ...
                <FAB
                    ...
                    onPress={() => this.props.navigation.navigate('AccommodationsType')}
                />                
            </Block>
        );
    }
