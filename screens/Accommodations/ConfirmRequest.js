...
export default class ConfirmRequest extends React.Component {
    ...
    ok=()=>{
        if (this.state.customerId != 0) {
            this.props.navigation.navigate('Accommodations')
        } else {
            this.props.navigation.navigate('AccommodationsType')
        }
    }
    request = () => {
        var data = {
            ...
            appointment: {
                ...
                _start_date: moment(this.props.route.params.selectDate,'YYYY/MM/DD').add(1,'days').unix(),
                _end_date: moment(this.props.route.params.selectDate, "YYYY/MM/DD").add(this.props.route.params.noOfDays, 'days').unix(),
                _all_day: true,
                _qty: this.props.route.params.noOfRooms == "" ? 1 : this.props.route.params.noOfRooms,
            ...
            line_items: [
                {
                    ...
                    quantity: this.props.route.params.noOfRooms==""?1:this.props.route.params.noOfRooms
                }
            ]
        }
                        ...
                        <DataTable.Row>
                            <Block>
                                <Text
                                    ...
                                    color={nowTheme.COLORS.HEADER}
                                >
                                    {this.props.route.params.roomName}  × {this.props.route.params.noOfRooms==""?1:this.props.route.params.noOfRooms}
                                </Text>
                                <Text
                                    size={14}
                                    style={styles.orderText}
                                ...
                                <Text
                                    ...
                                    color={nowTheme.COLORS.HEADER}
                                >
                                    Duration: {this.props.route.params.noOfDays} day
                                </Text>
                                <Text
                                    size={14}
                                    style={styles.orderText}
